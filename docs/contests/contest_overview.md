...
This section will show you the different options available for your contest.  You add Questions and Answers here as well as Configure Options for the contest (like how many times someone can vote), [Print or Download](#printdownload) your contest as a PDF or PNG files, finally - [Pay and Launch](#pay-and-launch) your contest.
...
3. Clicking the far right icon <span class="inline-icon"><i class="fa-regular fa-copy"></i></span> will copy the URL for the .zip file to your copy/paste buffer.
